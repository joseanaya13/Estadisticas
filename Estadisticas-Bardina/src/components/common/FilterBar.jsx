...
const FilterBar = ({
  ...
  mapas = {},
  filtros = {},
  empresasData = [], // ← AGREGAR ESTE PARÁMETRO
  onChange,
  onReset,
  showAdvanced = false,
  className = "",
  ...
  const filterConfig = useAdaptiveFilters(
    context,
    data,
    mapas,
    filtros,
          ...
          <div key={id} className="filter-field filter-range">
            ...
            <div className="range-inputs">
              <input
                ...
                value={value?.min || ""}
                onChange={(e) =>
                  onChange(id, { ...value, min: e.target.value })
                }
              />
              ...
              <input
                ...
                value={value?.max || ""}
                onChange={(e) =>
                  onChange(id, { ...value, max: e.target.value })
                }
              />
            </div>
          </div>
  ...
  return (
    <div
      className={`filter-bar ${className} ${isCollapsed ? "collapsed" : ""}`}
    >
      {/* Header de filtros */}
            ...
            <div className="advanced-filters">
              ...
              <div className="filter-groups">
                {Object.entries(filterGroups).map(
                  ([groupName, groupFilters]) => {
                    const secondaryGroupFilters = groupFilters.filter(
                      (f) => !f.isPrimary
                    );
